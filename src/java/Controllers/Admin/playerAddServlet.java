...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (playerName == null || playerName.trim().isEmpty() ||
        playerNumber == null || playerNumber.trim().isEmpty() ||
        ...
        countryId == null || countryId.trim().isEmpty() ||
        playerRoleId == null || playerRoleId.trim().isEmpty() ||
        atk == null || atk.trim().isEmpty() ||
        def == null || def.trim().isEmpty() ||
        spd == null || spd.trim().isEmpty()) {
        
        response.getWriter().println("Please make sure all fields are not null or empty");}
    else {
