            ...
            <div class="login" id="login">
                ...
                <form action="./signIn" class="login__form" method="POST">
                    ...
                    <div class="login__social">
                        <a class="login__google" href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/TicketGoal/googleLogin&response_type=code&client_id=550821903410-138bsqhr6mcm321bagemu78a3cd2ctr7.apps.googleusercontent.com&approval_prompt=force">
