    ...
    <div style="width: 100%; padding: 15px;">
        ...
        <div class="cart-items" style="width: 100%; margin: 0; margin-top: 10px;">
            <c:forEach var="ticket" items="${tickets}">
                <div class="cart-item"
                     style="position: relative; padding: 10px; border: 1px solid #ddd; margin-bottom: 10px;">
                    <!-- Label at the top right corner -->
                    <div class="label"
                         style="position: absolute; top: 10px; right: 10px; background: #ff5733; color: white; padding: 5px; border-radius: 3px;">
                        Paid
                    </div>
                    <div class="ticket-info">
                        ...
                        <div class="qr-code-button" style="margin-top: 10px;">
                            <button onclick="generateQRCode('${ticket.code}')"
...
<div id="qrPopup"
     style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); padding: 20px; background: white; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
