...
<div class="container">
        ...
        <table id="operatorTable">
            ...
            <c:forEach items="${promotions}" var="promotion">
                ...
                <div id="viewPromotionModal${promotion.promotionId}" class="modal">
                    <div class="modal-content">
                        <span class="close-btn"
                              onclick="document.getElementById('viewPromotionModal${promotion.promotionId}').style.display = 'none'">&times;</span>
                ...
                <div id="editPromotionModal${promotion.promotionId}" class="modal">
                    <div class="modal-content">
                        <span class="close-btn"
                              onclick="document.getElementById('editPromotionModal${promotion.promotionId}').style.display = 'none'">&times;</span>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" cols="50" name='description' required
                                                  value="${promotion.promotionDescription}">${promotion.promotionDescription}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button"
                                                onclick="document.getElementById('editPromotionModal${promotion.promotionId}').style.display = 'none'">
                                            Cancel
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="pagination">
        <button class="prev-page"
                onclick="window.location.href = './promotionManagement?index=${pageIndex -1}'"  ${pageIndex <= 1 ? "disabled" : ""}>
            Previous
        </button>
        ...
        <button class="next-page"
                onclick="window.location.href = './promotionManagement?index=${pageIndex + 1}'"  ${pageIndex < totalPage ? "" : "disabled"} >
            Next</a></button>
    </div>
</div>
    ...
    <div class="modal-content">
        ...
        <form method="POST" action="./promotionManagement">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="submit">Save</button>
                    <button type="button" onclick="document.getElementById('new-promotion').style.display = 'none'">
                        Cancel
                    </button>
                </div>
            </div>
